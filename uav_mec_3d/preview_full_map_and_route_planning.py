...
class PathPlanner:
    ...
    def _a_star_in_area(self, start, goal, area_name, max_neighbors=20):
        ...
        print(f"在区域 {area_name} 中未找到从起点 {start} 到终点 {goal} 的路径")
        return []
...
def exhaustive_test_entry():
    ...
    # 输出文件路径（可改名/改路径）
    # out_path = r"L:\python_projects\AirSim-main\PythonClient\multirotor\reconst\10\nav_pairs_paths.jsonl"
    # out_path = r"L:\python_projects\AirSim-main\PythonClient\multirotor\reconst\20\nav_pairs_paths.jsonl"
    # out_path = r"L:\python_projects\AirSim-main\PythonClient\multirotor\san_fran\scenario1\nav_pairs_paths.jsonl"
    # out_path = r"L:\python_projects\AirSim-main\PythonClient\multirotor\san_fran\scenario2\nav_pairs_paths.jsonl"
    out_path = r"L:\python_projects\AirSim-main\PythonClient\multirotor\san_fran\scenario3\nav_pairs_paths.jsonl"
...
def main():
    # # 一键全量测试
    exhaustive_test_entry() ###注释了防止重新写入
    print()
